...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `pharmacy_license` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `customers` (`id`, `full_name`, `phone`, `email`, `address`, `date_of_birth`, `gender`, `loyalty_points`, `notes`, `customer_type`, `tier`, `pharmacy_license`, `credit_limit`, `current_debt`, `created_at`, `updated_at`) VALUES
(1, 'nguyen van a', '0901000001', 'a@gmail.com', 'quy nhons', NULL, NULL, 0, NULL, 'INDIVIDUAL', 'REGULAR', NULL, '0.00', '0.00', '2025-12-21 19:53:19', '2025-12-24 16:08:16'),
(2, 'tran thi b', '0901000002', 'b@gmail.com', 'quy nhon', NULL, NULL, 0, NULL, 'INDIVIDUAL', 'REGULAR', NULL, '0.00', '0.00', '2025-12-21 19:53:19', '2025-12-22 09:10:16'),
(4, 'nguyen van a', '0900000000', 'a@test.com', 'quy nhon - updated', '2003-01-01', 'MALE', 10, 'cap nhat', 'INDIVIDUAL', 'REGULAR', NULL, '0.00', '0.00', '2025-12-22 09:33:10', '2025-12-22 09:33:56'),
(5, 'adsasaddsadsa', 'sadsda', 'asdsda', 'dsasa', NULL, NULL, 0, 'dsasad', 'INDIVIDUAL', 'REGULAR', NULL, '0.00', '0.00', '2025-12-24 16:21:37', '2025-12-24 16:21:42'),
(6, 'PHAM GIA HIEP', 'saddsa', 'saddsa', '4642 Grant View Drive', NULL, NULL, 0, 'dsa', 'INDIVIDUAL', 'REGULAR', NULL, '0.00', '0.00', '2025-12-25 18:16:33', '2025-12-25 18:16:33'),
(7, 'Nhà thuốc ABC', '0901888888', 'abc@pharmacy.com', '123 Nguyễn Huệ, Q1, HCM', NULL, NULL, 5000, NULL, 'PHARMACY', 'GOLD', 'GP-2024-001234', '50000000.00', '0.00', '2026-02-08 20:43:46', '2026-02-08 20:43:46');
